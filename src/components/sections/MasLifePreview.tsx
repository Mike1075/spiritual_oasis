  ...
  return (
    <section className="relative overflow-hidden bg-black py-24">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-purple-400/30 bg-gradient-to-br from-purple-600/15 via-fuchsia-600/10 to-emerald-500/10 p-8 md:p-12">
          ...
          <ul className="mb-9 grid gap-3 sm:grid-cols-3">
            {HIGHLIGHTS.map((h) => (
              <li
                key={h.text}
